...
const CharacterSVG = ({
  ...
  const renderDefs = () => (
    <defs>
      ...
      <radialGradient id="skinHighlight" cx="0.3" cy="0.3" r="0.5"><stop offset="0%" stopColor="rgba(255,255,255,0.5)"/><stop offset="100%" stopColor="rgba(255,255,255,0)"/></radialGradient>
      <linearGradient id="skinShadow" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="rgba(160,82,45,0)"/><stop offset="100%" stopColor="rgba(160,82,45,0.2)"/></linearGradient>
      ...
      {/* HAIR */}
      <linearGradient id="hairLuna" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#4B0082"/><stop offset="100%" stopColor="#2E0854"/></linearGradient>
      ...
      <linearGradient id="hairRed" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#FF4500"/><stop offset="100%" stopColor="#8B0000"/></linearGradient>
      <linearGradient id="hairSilver" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#FFF"/><stop offset="100%" stopColor="#AAA"/></linearGradient>
      <linearGradient id="hairBlack" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#444"/><stop offset="100%" stopColor="#111"/></linearGradient>
      <linearGradient id="hairSky" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#E0FFFF"/><stop offset="100%" stopColor="#00BFFF"/></linearGradient>

      {/* FABRICS */}
      <linearGradient id="latex" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="#444"/><stop offset="20%" stopColor="#777"/><stop offset="50%" stopColor="#222"/><stop offset="80%" stopColor="#666"/><stop offset="100%" stopColor="#111"/></linearGradient>
      ...
      <linearGradient id="silkRed" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#FF4d4d"/><stop offset="100%" stopColor="#900"/></linearGradient>
      <radialGradient id="void"><stop offset="0%" stopColor="#000"/><stop offset="100%" stopColor="#4B0082"/></radialGradient>

      <filter id="softShadow"><feGaussianBlur stdDeviation="2" result="blur"/><feOffset in="blur" dx="0" dy="2" result="offsetBlur"/><feMerge><feMergeNode in="offsetBlur"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
    </defs>
  );
