...
export default function Lobby() {
            ...
            try {
                ...
                if (resIslands.data.status === 'success') {
                    const progressionIslands = resIslands.data.data.map(island => {
                        ...
                        // Apply highly specific themes based on the 5 V3 Islands
                        let theme = { 
                            bgGrad: 'from-gray-900/40', 
                            border: 'border-gray-500/50', 
                            hoverBorder: 'hover:border-gray-400', 
                            shadow: 'shadow-[0_0_30px_rgba(156,163,175,0.3)]', 
                            hoverShadow: 'hover:shadow-[0_0_50px_rgba(156,163,175,0.5)]', 
                            text: 'text-gray-400', 
                            bgBadge: 'bg-gray-950/80',
                            accentColor: '#9ca3af'
                        };
                        ...
                        switch(parseInt(island.id)) {
                            case 1: // Kyoto Zen
                                totalMachines = 900; 
                                theme = { bgGrad: 'from-red-900/40', border: 'border-red-500/50', hoverBorder: 'hover:border-red-400', shadow: 'shadow-[0_0_30px_rgba(239,68,68,0.3)]', hoverShadow: 'group-hover:shadow-[0_0_60px_rgba(239,68,68,0.6)]', text: 'text-red-400', bgBadge: 'bg-red-950/80', accentColor: '#ef4444' }; 
                                break;
                            case 2: // Okinawa Tropic
                                totalMachines = 720; 
                                theme = { bgGrad: 'from-blue-900/40', border: 'border-cyan-500/50', hoverBorder: 'hover:border-cyan-400', shadow: 'shadow-[0_0_30px_rgba(6,182,212,0.3)]', hoverShadow: 'group-hover:shadow-[0_0_60px_rgba(6,182,212,0.6)]', text: 'text-cyan-400', bgBadge: 'bg-cyan-950/80', accentColor: '#06b6d4' }; 
                                break;
                            case 3: // Osaka Neon
                                totalMachines = 540; 
                                theme = { bgGrad: 'from-orange-900/40', border: 'border-orange-500/50', hoverBorder: 'hover:border-orange-400', shadow: 'shadow-[0_0_30px_rgba(249,115,22,0.3)]', hoverShadow: 'group-hover:shadow-[0_0_60px_rgba(249,115,22,0.6)]', text: 'text-orange-400', bgBadge: 'bg-orange-950/80', accentColor: '#f97316' }; 
                                break;
                            case 4: // Tokyo Cyber
                                totalMachines = 360; 
                                theme = { bgGrad: 'from-pink-900/40', border: 'border-pink-500/50', hoverBorder: 'hover:border-pink-400', shadow: 'shadow-[0_0_30px_rgba(236,72,153,0.3)]', hoverShadow: 'group-hover:shadow-[0_0_60px_rgba(236,72,153,0.6)]', text: 'text-pink-400', bgBadge: 'bg-pink-950/80', accentColor: '#ec4899' }; 
                                break;
                            case 5: // Ginza Gold
                                totalMachines = 180; 
                                theme = { bgGrad: 'from-purple-900/40', border: 'border-purple-500/50', hoverBorder: 'hover:border-purple-400', shadow: 'shadow-[0_0_30px_rgba(168,85,247,0.3)]', hoverShadow: 'group-hover:shadow-[0_0_60px_rgba(168,85,247,0.6)]', text: 'text-purple-400', bgBadge: 'bg-purple-950/80', accentColor: '#a855f7' }; 
                                break;
                            default: 
                                totalMachines = 200;
                        }
    ...
    // --- BACKGROUND IMAGE PRE-FETCHER (Lazy-Load Optimization) ---
    useEffect(() => {
        if (islands.length > 0) {
        ...
        return (
            <div className="bg-[#050505] min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative z-10 flex flex-col items-center">
                    <h1 className="text-4xl font-black text-white italic tracking-widest mb-2 drop-shadow-[0_0_15px_rgba(255,192,203,0.5)]">SUROPARA</h1>
    ...
    return (
        <div className="min-h-[100dvh] bg-[#050505] pb-[90px] relative overflow-hidden flex flex-col selection:bg-pink-500 selection:text-black font-sans">
            ...
            <div className="flex-1 relative flex items-center justify-center perspective-1000 mt-2 sm:mt-4 mb-6">
                ...
                {/* Dynamic Background Gradient based on Selected Island */}
                <div className={`absolute inset-0 transition-colors duration-1000 opacity-60 bg-gradient-to-b ${selectedIsland?.theme?.bgGrad || 'from-black'} via-transparent to-black pointer-events-none`} />
                ...
                {selectedIsland && (
                    <div 
                        className={`relative w-[85%] sm:w-[70%] md:max-w-[450px] h-[50vh] sm:h-[55vh] md:h-[60vh] group cursor-pointer transform-style-3d transition-all duration-300 ease-out ${isTransitioning ? 'scale-95 opacity-50 rotate-y-6' : 'scale-100 opacity-100'}`} 
                        onClick={() => handleEnter(selectedIsland)}
                    >
                        <div className={`w-full h-full rounded-[2rem] overflow-hidden border-2 shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative transition-all duration-500 
                            ...
                            {/* Fast Lazy-Loaded Background Image */}
                            ...
                            <div className="absolute bottom-6 left-5 sm:left-8 right-5 sm:right-8 z-30">
                                ...
                                {/* Strict VIP Progression Bar for Locked Islands */}
                                {!isOwned && (
            ...
            {/* Dots Pagination with Dynamic Color */}
